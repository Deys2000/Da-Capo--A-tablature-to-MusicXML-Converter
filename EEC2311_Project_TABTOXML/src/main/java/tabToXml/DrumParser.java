...
public class DrumParser {
	...
	public DrumParser(TextFileReader passedtfr ) throws Exception {
		tfr = passedtfr;
...
//		exampleInput.add(m2);
	 ...
	 * @return
	 */
	public String[] transpose (ArrayList<String> currentMeasure) {
	 ...
	 * @return
	 */
	public int returnVoice( String instrumentInitials) {
	...
	public ArrayList<String> getInstrumentInitials(){
